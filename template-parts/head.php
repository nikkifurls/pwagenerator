...
if (!empty($project_data['fonts'])) {
    ...
    foreach ($font_weights as $font_weight) {
        foreach ($fonts as $font) {
            ...
            if (
                file_exists(dirname(__DIR__, 2) . '/' . $project_data['url'] . '/' . $font_url_eot) &&
...
<?php if (!empty($project_data['opt_files']) && in_array('opt/google_auth.js', $project_data['opt_files'])) { ?>
    <?php
    $google_api_client_id = !empty($project_data['google_api']['google_api_client_id'])
        ? $project_data['google_api']['google_api_client_id']
        : '';
    $google_api_key = !empty($project_data['google_api']['google_api_key'])
        ? $project_data['google_api']['google_api_key']
        : '';
    $google_api_scope = !empty($project_data['google_api']['google_api_scope'])
        ? $project_data['google_api']['google_api_scope']
        : '';
    $google_api_url = !empty($project_data['google_api']['google_api_url'])
        ? $project_data['google_api']['google_api_url']
        : '';
    $google_api_callback = !empty($project_data['google_api']['google_api_callback'])
        ? $project_data['google_api']['google_api_callback']
        : '';
    ?>
    
    <script defer
        src='./opt/google_auth.js'
        api_client_id='<?php echo $google_api_client_id ?>'
        api_key='<?php echo $google_api_key ?>'
        api_scope='<?php echo $google_api_scope ?>'
        api_url='<?php echo $google_api_url ?>'
        api_callback='<?php echo $google_api_callback ?>'
    >
    </script>
